...
CONTEXT_MAP = {
    ...
    "accounts:mfa_status": "continuity/two-factor",
    "accounts:mfa_setup": "continuity/two-factor",
    "accounts:mfa_challenge": "continuity/two-factor",
    "laboratory:print_labels": "continuity/labels",
    ...
    "interop:host_query_list": "integrations/host-query",
    "interop:message_list": "interoperability/instrument-interfaces",
    "interop:icd10_list": "integrations/icd10-diagnoses",
    "rules:rule_list": "rules-and-automation/why-rules",
    "rules:rule_create": "rules-and-automation/writing-a-rule",
    "rules:rule_update": "rules-and-automation/writing-a-rule",
    "rules:rule_detail": "rules-and-automation/approving-a-rule",
    "rules:execution_list": "rules-and-automation/autoverification",
    "rules:execution_detail": "rules-and-automation/autoverification",
    "operations:exception_list": "rules-and-automation/exception-queue",
    "operations:exception_detail": "rules-and-automation/exception-queue",
    "compliance:subject_request_list": "privacy-rights/data-subject-requests",
    "compliance:subject_request_detail": "privacy-rights/data-subject-requests",
    "integrations:client_list": "integrations/the-rest-api",
    "integrations:client_create": "integrations/the-rest-api",
    "integrations:client_update": "integrations/the-rest-api",
    "integrations:webhook_list": "integrations/webhooks",
    "integrations:webhook_create": "integrations/webhooks",
    "integrations:webhook_update": "integrations/webhooks",
